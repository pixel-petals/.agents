...
As a general rule of thumb: one or two layers of abstraction is typically sufficient when combined with patterns for composition and middleware (decoupling).
